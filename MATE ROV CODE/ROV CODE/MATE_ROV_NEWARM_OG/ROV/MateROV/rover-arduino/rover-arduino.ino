...
const byte servoPin_rotate = 24;

// --- H-bridge pins ---
// DC Motor 1 (Dpad Left/Right)
const byte M1_IN1 = 48;
const byte M1_IN2 = 49;

// DC Motor 2 (Dpad Up/Down)
const byte M2_IN1 = 50;
const byte M2_IN2 = 51;
...
void driveMotor(byte in1, byte in2, float value) {
  if (value > 0.1f) {
...
void applyControls(const ROVPacket& p) {
  ...
  driveMotor(M1_IN1, M1_IN2, p.dc_motor);
  driveMotor(M2_IN1, M2_IN2, p.dc_motor2);
}
